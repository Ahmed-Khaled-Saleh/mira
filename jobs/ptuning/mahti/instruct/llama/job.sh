...
#SBATCH --job-name=ptuning_mahti_instruct_llama
...
#SBATCH --output=logs/ptuning/instruct/llama/out.out
#SBATCH --error=logs/ptuning/instruct/llama/out.err
...
srun python main.py --fname ./configs/ptuning/instruct/llama/configs.yaml

...
#SBATCH --job-name=ptuning_mahti_dolly_gemma
...
#SBATCH --output=logs/ptuning/dolly/gemma/out.out
#SBATCH --error=logs/ptuning/dolly/gemma/out.err
...
srun python main.py --fname ./configs/ptuning/dolly/gemma/configs.yaml

...
#SBATCH --job-name=puhti_fedkseed_t5_instruct
...
#SBATCH --output=logs/puhti_fedkseed_t5_instruct.out
#SBATCH --error=logs/puhti_fedkseed_t5_instruct.err
...
srun python main.py --fname ./configs/fedk/configs_fedk_instruct_t5.yaml

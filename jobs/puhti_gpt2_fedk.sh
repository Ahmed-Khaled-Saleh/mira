...
#SBATCH --job-name=puhti_fedkseed_gpt2
...
#SBATCH --output=logs/puhti_fedkseed_gpt2.out
#SBATCH --error=logs/puhti_fedkseed_gpt2.err
...
srun python main.py --fname ./configs/fedk/configs_gpt2_instruct.yaml

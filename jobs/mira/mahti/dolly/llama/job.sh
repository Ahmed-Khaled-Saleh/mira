...
#SBATCH --job-name=mira_mahti_dolly_llama
...
#SBATCH --output=logs/mira/dolly/llama/out.out
#SBATCH --error=logs/mira/dolly/llama/out.err
...
srun python main.py --fname ./configs/mira/dolly/llama/configs.yaml

...
#SBATCH --job-name=mahti_fedit_instruct_gemma
...
#SBATCH --output=logs/fedit/instruct/gemma/out.out
#SBATCH --error=logs/fedit/instruct/gemma/out.err
...
srun python main.py --fname ./configs/fedit/instruct/gemma/configs.yaml

...
#SBATCH --job-name=mahti_fedit_instruct_gpt2
...
#SBATCH --output=logs/mahti_fedit_instruct_gpt2.out
#SBATCH --error=logs/mahti_fedit_instruct_gpt2.err
...
srun python main.py --fname ./configs/fedit/configs_fedit_instruct_gpt2.yaml

...
#SBATCH --job-name=mahti_fedit_dolly_t5
...
#SBATCH --output=logs/mahti_fedit_dolly_t5.out
#SBATCH --error=logs/mahti_fedit_dolly_t5.err
...
srun python main.py --fname ./configs/fedit/configs_fedit_dolly_t5.yaml

...
#SBATCH --job-name=mira_puhti_instruct_llama
...
#SBATCH --output=logs/mira/instruct/llama/out.out
#SBATCH --error=logs/mira/instruct/llama/out.err
...
srun python main.py --fname ./configs/mira/instruct/llama/configs.yaml

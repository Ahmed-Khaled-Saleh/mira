...
#SBATCH --job-name=mira_plus_mahti_dolly_llama
...
#SBATCH --output=logs/mira_plus/dolly/llama/out.out
#SBATCH --error=logs/mira_plus/dolly/llama/out.err
...
srun python main.py --fname ./configs/mira_plus/dolly/llama/configs.yaml

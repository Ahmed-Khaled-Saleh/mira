...
#SBATCH --job-name=puhti_fedkseed_t5_dolly
...
#SBATCH --output=logs/puhti_fedkseed_t5_dolly.out
#SBATCH --error=logs/puhti_fedkseed_t5_dolly.err
...
srun python main.py --fname ./configs/fedk/configs_fedk_dolly_t5.yaml
